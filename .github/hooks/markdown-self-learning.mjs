...
async function refreshPrimeFile(root, state) {
	const agentsText = await readOptionalFile(join(root, "AGENTS.md"));
	...
	const primeSections = [
		"# Markdown self-learning context",
		"",
		"This file is generated by the hook pack.",
		"AGENTS.md remains the durable source of truth; this file is a session-friendly snapshot.",
		"",
		"## Durable instructions from AGENTS.md",
		agentsText.trim() || "_AGENTS.md is missing_",
	];
